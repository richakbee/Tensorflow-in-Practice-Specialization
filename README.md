...
**My certification** : https://coursera.org/share/9fac19050fc05b3e723d9ce7f3eaf1e4
...
- Assignment 1.1 - Detecting sarcasm in news headlines with LSTM and CNN.ipynb
- Assignment 1.2 - Exploring BBC news data.ipynb
...
- Assignment 2.1 - Classifying IMDB reviews data (Embedding + MLP).ipynb
- Assignment 2.2 - Classifying BBC news into topics (Embedding + Conv + MLP).ipynb
...
- Tips from Laurence
- Assignment 3.1 - Classifying IMDB reviews (Embedding + Conv1D).ipynb
- Assignment 3.2 - Twitter sentiment classification (GloVe).ipynb
...
- Poetry!
- Laurence the poet
- Assignment 4 - Poem generation with Bi-directional LSTM.ipynb
